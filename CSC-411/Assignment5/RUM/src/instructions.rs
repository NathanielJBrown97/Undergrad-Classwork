...
// DEBUG PRINT    println!("Before cond_move: A = {}, B = {}, C = {}", registers[a as usize], registers[b as usize], registers[c as usize]);
...
// DEBUG PRINT    println!("After cond_move: A = {}, B = {}, C = {}", registers[a as usize], registers[b as usize], registers[c as usize]);
}
